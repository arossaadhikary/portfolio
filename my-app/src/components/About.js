            ...
            <ul className = "about_items">
                <li className = "about_item">
                    <div>
                        ...
                        <p>
                            My name is Arossa - I'm an ambitious, goal-oriented, 2nd-year undergraduate honors student at the University of Florida. I strive to use my coding knowledge to make a social impact, with a specific interest in <span className = "highlight">public service, protecting digital infrastructure, & education</span>.
